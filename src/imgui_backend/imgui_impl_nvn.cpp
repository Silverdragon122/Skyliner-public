...
// Should you import cpp? no. Am I going to anyway? yes.
#include "program/skyliner_imguifont.cpp"
...
// backend impl
    ...
    bool setupFont() {
        ...
        // load switch font data into imgui
         ...
         io.Fonts->AddFontFromMemoryCompressedBase85TTF(skyliner_compressed_data_base85, 16.0f);
        ...
        bd->samplerBuilder.SetDefaults()
                .SetDevice(bd->device)
                .SetMinMagFilter(nvn::MinFilter::NEAREST, nvn::MagFilter::NEAREST) // Changed from LINEAR to NEAREST
